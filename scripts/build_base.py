...
*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 20% 0,rgba(80,177,249,.2),transparent 34%),var(--bg);color:var(--ink);font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,'Segoe UI',Arial,sans-serif}.topbar{position:sticky;top:0;z-index:3;display:flex;justify-content:space-between;gap:20px;padding:18px 28px;background:rgba(7,11,18,.78);backdrop-filter:blur(18px);border-bottom:1px solid rgba(255,255,255,.08)}.topbar a{color:var(--ink);text-decoration:none;font-weight:700}.topbar nav{display:flex;gap:16px}.home,.article{width:min(1080px,calc(100% - 36px));margin:0 auto;padding:76px 0}.article{width:min(820px,calc(100% - 36px))}.eyebrow{color:var(--blue);font-weight:800;text-transform:uppercase;letter-spacing:.14em;font-size:12px}h1{font-size:clamp(38px,6vw,78px);line-height:.94;margin:16px 0 22px;letter-spacing:-.06em}.article h1{font-size:clamp(34px,5vw,58px)}.lead{color:var(--muted);font-size:20px;line-height:1.55;max-width:760px}.filters{display:flex;flex-wrap:wrap;gap:10px;margin:34px 0}.filters span{border:1px solid var(--line);border-radius:999px;padding:9px 13px;color:var(--muted)}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:18px;margin-top:24px}.card{display:block;min-height:220px;padding:24px;border:1px solid var(--line);border-radius:24px;background:linear-gradient(135deg,rgba(80,177,249,.14),rgba(255,255,255,.04));color:var(--ink);text-decoration:none}.card span{color:var(--blue);font-size:12px;text-transform:uppercase;letter-spacing:.12em}.card strong{display:block;margin:14px 0 10px;font-size:23px;line-height:1.12}.card p{color:var(--muted);line-height:1.5}.article section{font-size:19px;line-height:1.72;color:#dbe4f0}.article h2{font-size:30px;margin-top:42px}.article h3{font-size:23px;margin-top:30px}.article a{color:var(--blue)}.hero-image{margin:34px 0;border:1px solid var(--line);border-radius:26px;overflow:hidden;background:rgba(255,255,255,.04)}.hero-image img{display:block;width:100%;height:auto}.hero-image figcaption{padding:12px 16px;color:var(--muted);font-size:14px}.article code{background:rgba(255,255,255,.08);padding:2px 6px;border-radius:7px}.wikilink{color:var(--blue);border-bottom:1px dashed var(--blue)}footer{margin-top:52px;border-top:1px solid rgba(255,255,255,.1);padding-top:24px}@media(max-width:640px){.topbar{padding:14px 18px}.home,.article{padding:52px 0}h1{letter-spacing:-.04em}.lead{font-size:18px}}
""".strip()
